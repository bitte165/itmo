...
public class Main {
    public static void main(String[] args) {
        ...
        House.Room room = house.new Room("Комната");
        ...
        if (gunilla.getLocation() != room && krsiter.getLocation() != room
                && junior.getLocation() == room && puppy.getLocation() == room) {
